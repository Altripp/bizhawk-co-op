...
$url = "https://github.com/Altripp/bizhawk-co-op/archive/debug.zip"
...
Move-Item -Path .\bizhawk-co-op-debug\* -Destination .\BizHawk-2.3\
Remove-Item .\bizhawk-co-op-debug -Recurse
